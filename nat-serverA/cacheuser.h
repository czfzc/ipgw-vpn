...
class cacheuser{
    public:
        ...
        /*绑定client和serverB */
        bool bind(u_int16_t c_uport,u_int32_t c_ip,u_int32_t c_subnet_ip,u_char* session_key);
        /*解绑定client和serverB */
...
bool cacheuser::bind(u_int16_t c_uport,u_int32_t c_ip,u_int32_t c_subnet_ip,u_char* session_key){
